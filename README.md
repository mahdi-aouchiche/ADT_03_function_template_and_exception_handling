...
Author: Mahdi Aouchiche (<https://github.com/mahdi-aouchiche/function_template_and_exception_handling>)
...
* Implement a template function to return the element at a given index of a vector of a certain type.
* Create a harness test to check the validity of the sort function.
* Test the correctness of the functions using standard output in main.
* Use google unit tests to automate the tests for each template function output and exception handling.
